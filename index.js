...
/* fetches the  movies which are in API*/
...
/* Function for add or remove the favorite list*/
function addRemoveToFavList(id) {
 ...
 /* movie details will be displayed*/
async function showMovieDetails(itemId, searchInput) {
    console.log("searchInput:...............", searchInput);
    const list = JSON.parse(localStorage.getItem(dbObjectFavList));
    flexBox.scrollTo({ top: 0, behavior: "smooth" });
    const url = "https://www.omdbapi.com/?apikey=fd0367c8&i=";
    const searchUrl = "https://www.omdbapi.com/?apikey=fd0367c8&s=";
            ...
            <div class="fixed" id="search-bar">
                ...
                <div class="new-search-input">
                    <form onkeyup="showMovieList()">
                        <input id="search-input" type="text" placeholder="Search Your Favorite Movies Here..." />
                    </form>
                </div>
            </div>
        </div>
...
async function showFavMovieList() {
    ...
    let url = "https://www.omdbapi.com/?apikey=fd0367c8&i=";
    let html = "";
    ...
    if (favList.length == 0) {
        ...
        for (let i = 0; i < favList.length; i++) {
            ...
            if (favmovieList) {
                ...
                <div class="fav-item-photo"  onclick="showMovieDetails('${element.imdbID}','Matthew')">
                <img src="${element.Poster=='N/A' ? './assets/backdrop.jpg' : element.Poster}" alt="">
                </div>
